...
CREATE TABLE `matches` (
  ...
  `unmatched_reason` varchar(191) DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NULL DEFAULT NULL
) ;
...
CREATE TABLE `moderation_queues` (
  ...
  `flag_reason` varchar(191) NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `otps` (
  ...
  `identifier` varchar(191) NOT NULL COMMENT 'Email or Phone',
...
CREATE TABLE `profile_prompts` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `uuid` char(36) NOT NULL ,
  `prompt_text` varchar(191) NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `user_authentications` (
  ...
  `provider_id` varchar(191) DEFAULT NULL COMMENT 'External ID for OAuth',
...
CREATE TABLE `user_profiles` (
  ...
  `hometown` varchar(191) DEFAULT NULL,
  ...
  `language_spoken` varchar(191) DEFAULT NULL,
  `spotify_anthem_url` varchar(191) DEFAULT NULL,
  `instagram_username` varchar(191) DEFAULT NULL,
...
INSERT INTO `user_profiles` (`id`, `uuid`, `user_id`, `bio`, `height_cm`, `weight_kg`, `hometown`, `current_city_id`, `country_id`, `base_latitude`, `base_longitude`, `education_id`, `occupation_id`, `company`, `religion_id`, `political_view_id`, `smoking_id`, `drinking_id`, `fitness_id`, `sleep_id`, `diet_id`, `pets_id`, `children_id`, `love_language_id`, `communication_style_id`, `personality_type`, `zodiac_sign`, `job_title`, `language_spoken`, `spotify_anthem_url`, `instagram_username`, `website`, `compatibility_score_base`, `is_verified`, `created_at`, `updated_at`) VALUES
(5, '2c695a7a-82b9-11f1-a131-c85acfa46f9f', 4, 'Hello, I am a software engineer.', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 3, NULL, NULL, 1, 1, 1, 2, 3, 1, 2, NULL, 1, NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 50, 0, '2026-07-18 14:58:31', '2026-07-18 14:58:31'),
(6, 'a8851178-82bc-11f1-a131-c85acfa46f9f', 5, 'Hello, I am a software engineer.', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 3, NULL, NULL, 1, 1, 1, 2, 3, 1, 2, NULL, 1, NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 50, 0, '2026-07-18 15:23:28', '2026-07-18 15:23:28'),
(7, '2207d5a9-82cb-11f1-a131-c85acfa46f9f', 6, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 50, 0, '2026-07-18 17:07:05', '2026-07-18 17:07:05');
...
CREATE TABLE `user_subscriptions` (
  ...
  `platform_subscription_id` varchar(191) NOT NULL,
...
,`spotify_anthem_url` varchar(191)
...
--
-- Table structure for table `explore_interests`
--

CREATE TABLE `explore_interests` (
...
--
-- Table structure for table `explore_trending_categories`
--

CREATE TABLE `explore_trending_categories` (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
  `name` varchar(100) NOT NULL,
...
--
-- Table structure for table `user_daily_picks`
--

CREATE TABLE `user_daily_picks` (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
  `user_id` bigint(20) UNSIGNED NOT NULL,
...
--
-- Constraints for table `user_daily_picks`
--
ALTER TABLE `user_daily_picks`
  ADD CONSTRAINT `user_daily_picks_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `user_daily_picks_ibfk_2` FOREIGN KEY (`target_user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
...
ALTER TABLE `user_interactions`
  ...
  ADD CONSTRAINT `user_interactions_ibfk_2` FOREIGN KEY (`target_user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `user_views`
--
ALTER TABLE `user_views`
  ADD CONSTRAINT `user_views_ibfk_1` FOREIGN KEY (`viewer_id`) REFERENCES `users` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `user_views_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
